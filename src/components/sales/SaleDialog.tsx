...
const saleItemSchema = z.object({
  ...
  unit_price: z.number().min(0, "ราคาขายต้องไม่ติดลบ"),
});
...
const saleSchema = z.object({
  ...
  items: z.array(saleItemSchema).min(1, "กรุณาเพิ่มสินค้าอย่างน้อย 1 รายการ"),
});
...
export function SaleDialog({ open, onOpenChange, onSubmit }: SaleDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>สร้างใบขายใหม่</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {formData.sale_date ? format(formData.sale_date, "dd/MM/yyyy") : "เลือกวันที่"}
                  </Button>
                </PopoverTrigger>
          ...
          <div className="flex gap-3 justify-end">
            ...
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? "กำลังบันทึก..." : "สร้างใบขาย"}
            </Button>
          </div>
        </form>
      </DialogContent>
